...
os.environ['DATABRICKS_TOKEN'] = "mytoken" # Git does not allow for tokens to be pushed

index_name="databricks_1j4iyuf.llm.docs_idx"
host = "https://" + spark.conf.get("spark.databricks.workspaceUrl")
print(host)
VECTOR_SEARCH_ENDPOINT_NAME="emilangelov_vector_search"
...
model_name = "databricks_1j4iyuf.llm.appliance_chatbot_model"
